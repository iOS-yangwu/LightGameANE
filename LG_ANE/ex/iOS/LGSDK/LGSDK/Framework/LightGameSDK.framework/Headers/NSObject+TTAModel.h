 ...
 * Implementations of `NSCoding`, `NSCopying`, `-hash` and `-isEqual:`.
 ...
 See `TTAModel` protocol for custom methods.
 ...
 */
+ (nullable instancetype)tta_modelWithJSON:(id)json;
...
/**
 ...
 `NSString` -> SEL, Class.
 */
+ (nullable instancetype)tta_modelWithDictionary:(NSDictionary *)dictionary;
 ...
 */
- (nullable id)tta_modelToJSONObject;
 ...
 */
- (nullable NSData *)tta_modelToJSONData;
...
/**
 ...
 inner object to json string.
 */
- (nullable NSString *)tta_modelToJSONString;
 ...
 */
+ (nullable NSArray *)tta_modelArrayWithClass:(Class)cls json:(id)json;
 ...
 */
@interface NSDictionary (TTAModel)
 ...
 */
+ (nullable NSDictionary *)tta_modelDictionaryWithClass:(Class)cls json:(id)json;
@end
...
/**
 ...
 There's no need to add '<TTAModel>' to your class header.
 */
@protocol TTAModel <NSObject>
@optional
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)tta_modelCustomPropertyMapper;
 ...
 */
+ (nullable NSDictionary<NSString *, id> *)tta_modelContainerPropertyGenericClass;
...
/**
 ...
 (both singular and containers via `+tta_modelContainerPropertyGenericClass`).
 ...
 */
+ (nullable Class)tta_modelCustomClassForDictionary:(NSDictionary *)dictionary;
 ...
 */
+ (nullable NSArray<NSString *> *)tta_modelPropertyBlacklist;
...
/**
 ...
 @return An array of property's name.
 */
+ (nullable NSArray<NSString *> *)tta_modelPropertyWhitelist;

/**
 This method's behavior is similar to `- (BOOL)tta_modelCustomTransformFromDictionary:(NSDictionary *)dic;`,
 ...
 */
- (NSDictionary *)tta_modelCustomWillTransformFromDictionary:(NSDictionary *)dic;
 ...
 */
- (BOOL)tta_modelCustomTransformFromDictionary:(NSDictionary *)dic;
...
/**
 ...
 @return Returns YES if the model is valid, or NO to ignore this model.
 */
- (BOOL)tta_modelCustomTransformToDictionary:(NSMutableDictionary *)dic;
